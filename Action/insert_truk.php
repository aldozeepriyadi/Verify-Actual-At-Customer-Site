...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $namaTruk = $_POST['namaTruk'];
    $numberPoliceFront = $_POST['numberPoliceFront'];
    $numberPoliceMiddle = $_POST['numberPoliceMiddle'];
    $numberPoliceBack = $_POST['numberPoliceBack'];
    $numberPolice = $numberPoliceFront . " " . $numberPoliceMiddle . " " . $numberPoliceBack;
    $capacityTruk = $_POST['capacityTruk'];
    $jenisTruk = $_POST['jenisTruk'];
